...
<template>
    ...
    <div class="container mx-auto px-5">
        <header class="flex justify-between py-12 items-center">
            <div>
                <a href="/"><img src="https://seeklogo.com/images/U/universite-cadi-ayyad-marrakech-maroc-logo-CCE5BB11B1-seeklogo.com.png" alt="Site Logo"></a>
            </div>
            ...
            <nav class="flex justify-end flex-col md:flex-row">
                ...
                <ul
                    ...
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#features"
                            v-smooth-scroll>Features</a></li>
                    ...
                    <li class="uppercase hover:text-theme-secondary transition duration-200"><a href="#subscribe"
                            v-smooth-scroll>Subscribe</a></li>
                    <li
